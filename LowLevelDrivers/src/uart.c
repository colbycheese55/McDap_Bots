...
/* BLE/SNP UART is the SysConfig "BLUETOOTH" instance (UART1) */
static inline UART_Regs *U1(void) {
    return (UART_Regs *)BLUETOOTH_INST;
}
...
void UART_open(UART_Handle *h) {
    ...
    DL_UART_Main_setRXFIFOThreshold(h->inst,
